...
public class CombinationSumII {
    public ArrayList<ArrayList<Integer>> combinationSum(ArrayList<Integer> a, int b) {
        Collections.sort(a);
        return combo(new ArrayList<ArrayList<Integer>>(), new ArrayList<Integer>(), a, b,0,0);
    }
    public ArrayList<ArrayList<Integer>> combo(ArrayList<ArrayList<Integer>> res,  ArrayList<Integer> inp,ArrayList<Integer> a, int b, int sum, int index) {
        ...
        {
            inp.add(a.get(i));
            combo(res,inp,a,b,sum+a.get(i),i+1);
